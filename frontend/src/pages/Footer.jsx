        ...
        <div className="grid gap-14 border-b border-[#ece8e3] pb-16 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            ...
            >
              ...
              <img
                src={logo}
                alt="Wisenery"
                className="h-[46px] w-auto -translate-y-[6px] object-contain"
              />
            </a>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <a
                href="/#home"
                className="group flex w-fit items-center gap-2 text-sm text-[#111820] transition-colors duration-300 hover:text-[#FF7A29]"
              >
                Home

                <ArrowUpRight
                  size={14}
                  className="translate-x-[-4px] translate-y-[4px] opacity-0 transition-all duration-300 group-hover:translate-x-0 group-hover:translate-y-0 group-hover:opacity-100"
                />
              </a>
          ...
          <div>
            ...
            <div className="flex flex-col gap-5">
              ...
              <a
                href="#"
                className="group flex items-center gap-3 text-sm text-[#111820] transition-colors duration-300 hover:text-[#FF7A29]"
              >
                <svg
                  viewBox="0 0 24 24"
